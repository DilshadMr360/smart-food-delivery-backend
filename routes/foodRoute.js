...
import { addFood, getFoodCount, getFoodDetails, listFood, removeFood, updateFoodList, updateFoodQuantity} from '../controllers/foodController.js';
...
foodRouter.get('/food-count', getFoodCount);
